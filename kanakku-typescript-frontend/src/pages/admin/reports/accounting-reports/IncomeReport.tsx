        ...
        <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                {/* <StatsCard
                    ...
                    value={format(chartData?.service_revenue.currentMonthAmount || 0)}
                    difference={chartData?.service_revenue.percentage || 0}
                    icon={<Box size={25} className={getColorClass(chartData?.service_revenue.percentage)} />}
                    color={getColorClass(chartData?.service_revenue.percentage, true)}
                /> */}
            </div>
            {/* Filters*/}

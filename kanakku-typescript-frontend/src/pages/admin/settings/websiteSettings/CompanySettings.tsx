                ...
                >
                    <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <FormField
                            ...
                            name="publicBaseUrl"
                            type="text"
                            placeholder="https://kanakku.example.com"
                    ...
                    <div className="p-5 grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="col-span-1 md:col-span-2 flex items-start justify-between gap-4">
                            <div>
                                ...
                                <p className="text-xs text-body mt-1">
                                    Off by default. When on, Kanakku contacts the EU VIES service to verify VAT numbers; it fails open (never blocks a save) and stays fully offline when off.
                                </p>
                            </div>
                            <Switch

    ...
    return (
        <div className="flex flex-col items-center justify-center h-screen bg-gray-50">
            ...
            <button
                ...
                className="px-6 py-2 text-white bg-primary rounded-lg hover:bg-primary focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 transition cursor-pointer"
            >
                Back to Home
            </button>
        </div>

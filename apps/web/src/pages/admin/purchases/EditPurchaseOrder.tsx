...
const EditPurchaseOrder: React.FC = () => {
    ...
    const fetchPurchaseOrder = async () => {
        try {
            ...
            if (data) {
                // Contact-first prefill. The PO detail endpoint has no top-level contactId,
                // so read vendor.id (which is the contact id when the PO is contact-linked,
                // falling back to billTo for legacy records).

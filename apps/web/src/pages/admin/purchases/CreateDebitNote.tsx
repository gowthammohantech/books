                    ...
                    <div className="w-full">
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full">
                            ...
                            <div className="w-full">
                                <CostCenterSelect
                                    usage="purchase"
                                    value={debitNoteFormData.costCenterId}
                        ...
                        {debitNoteFormData.sign_type !== 'none' && (debitNoteFormData.sign_type === 'digitalSignature' ? (
                            ...
                            <div>
                                ...
                                <div className="mt-2 h-20 w-48 bg-gray-100 rounded-md flex items-center justify-center cursor-pointer border-2 border-dashed border-gray-400" onClick={() => setSignatureModalOpen(true)}>
                                    {debitNoteFormData.esignDataUrl ? <img src={debitNoteFormData.esignDataUrl} alt="Drawn Signature" className="max-h-full max-w-full" /> : <div className="text-center text-gray-700"><Edit size={20} className="mx-auto mb-1" /><span className="text-xs">Draw Signature</span></div>}
                                </div>

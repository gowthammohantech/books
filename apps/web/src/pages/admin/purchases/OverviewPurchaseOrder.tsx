            ...
            <div className='space-y-2' ref={componentRef}>
                ...
                <section className="flex justify-between mt-2">
                    ...
                    <div className="w-2/5">
                        ...
                        <p className="text-sm text-gray-700">{poData?.billTo?.address ?? ''}</p>
                        <p className="text-sm text-gray-700">{poData?.billTo?.email}</p>
                        <p className="text-sm text-gray-700">{poData?.billTo?.phone ?? ''}</p>
                    </div>
                ...
                <section className="mt-2 pt-2 border-t border-gray-200">
                    <p className="text-sm text-gray-700">Total Items / Qty : {poData?.items.length} / {poData?.items.reduce((sum, item) => sum + num(item.qty), 0)}</p>
                ...
                <footer className="mt-2 pt-2 flex justify-between border-t border-gray-200">
                    <div>
                        ...
                        <p className="text-sm text-gray-700">Bank : {poData?.bank?.name}</p>
                        <p className="text-sm text-gray-700">Account # : {poData?.bank?.accountNumber}</p>
                        <p className="text-sm text-gray-700">IFSC : {poData?.bank?.ifscCode}</p>
                        <p className="text-sm text-gray-700">BRANCH : {poData?.bank?.branchName}</p>
                    </div>

...
const EditQuotation: React.FC = () => {
    ...
    const fetchModuleSettings = async () => {
        try {
            ...
            if (data) {
                ...
                // Terms & notes load from the saved quotation record (fetchQuotationDetails);
                // the legacy per-module quotation terms/notes are retired. This fetch only
                // supplies the sales-person role.
    ...
    const validateQuotationData = () => {
        ...
        const lineFieldError = validateLineCustomFields(quotationFormData.items, lineFields, docCreatedAt);
    ...
    const saveQuotation = async (e: React.FormEvent) => {
        ...
        for (const [key, value] of Object.entries(quotationFormData)) {
            if (key === 'esignDataUrl' && quotationFormData.sign_type === 'eSignature') {
                ...
                if (file) formData.append('signatureImage', file);
                ...
                for (let index = 0; index < value.length; index++) {
                    ...
                    for (const [itemKey, itemValue] of Object.entries(item)) {
                        if (itemKey === 'tax_rate_id' && !itemValue) continue;
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full">
                            <div className="w-full">
                                <DateInput
                                    ...
                                    value={quotationFormData.quotationDate || null}
                            ...
                            <div className="w-full">
                                <DateInput
                                    label="Expiry Date"
                                    value={quotationFormData.expiryDate || null}
                ...
                <Modal isOpen={isSignatureModalOpen} onClose={() => setSignatureModalOpen(false)} title="Draw Signature">
                    <div className="p-4">
                        ...
                        <div className="flex justify-end gap-3 mt-4">
                            ...
                            <button type='button' onClick={() => setSignatureModalOpen(false)} className="px-4 py-2 text-sm font-medium text-gray-800 bg-gray-100 rounded-md hover:bg-gray-300 cursor-pointer">Cancel</button>

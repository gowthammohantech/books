            ...
            <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="flex items-start gap-4 mb-4">
                    <div className="relative w-24 h-24 border border-border rounded-md flex items-center justify-center overflow-hidden bg-card">
                        ...
                        {formData.signatureImage_preview_url && (
                            <button type="button" onClick={handleImageDelete} title="Remove Image" className="absolute top-[-1px] right-[-1px] bg-card border border-destructive rounded-full p-1 shadow-sm hover:bg-destructive group">

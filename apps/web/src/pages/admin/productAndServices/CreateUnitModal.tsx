        ...
        <Modal isOpen={isOpen} onClose={onClose} title="Create Unit">
            <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div>
                    ...
                    <input id="unit_name" name="unit_name" type="text" maxLength={50} value={formData.unit_name || ""} onChange={handleChange} placeholder="Enter Brand Name" className="w-full bg-card  text-gray-950  px-4 py-2 border border-gray-300  rounded-md text-sm focus:ring-ring focus:border-primary" />
                ...
                <div>
                    ...
                    <input id="short_name" name="short_name" type="text" maxLength={15} value={formData.short_name || ""} onChange={handleChange} placeholder="Enter Brand Name" className="w-full bg-card  text-gray-950  px-4 py-2 border border-gray-300  rounded-md text-sm focus:ring-ring focus:border-primary" />

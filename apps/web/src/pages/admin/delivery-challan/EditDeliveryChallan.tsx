        ...
        const fetchDeliveryChallanDetails = async () => {
            try {
                ...
                if (deliveryChallanDetail) {
                    ...
                    setDocCreatedAt((deliveryChallanDetail.createdAt as string | undefined) ?? null);
                    setInvoiceFormData((prev) => ({
                        ...
                        totalTax: deliveryChallanDetail.vat,
                ...
                <div className="bg-card  rounded-lg border border-gray-200 ">
                    <div className="p-4">
                        ...
                        <div className="p-4 flex">
                            <Button type='button' variant="ghost" onClick={() => handleNewRow()} leftIcon={<PlusCircle className="h-4 w-4" />}>
                                Add New Row
                            </Button>
                        </div>
                    </div>
                ...
                <Modal isOpen={isSignatureModalOpen} onClose={() => setSignatureModalOpen(false)} title="Draw Signature">
                    <div className="p-4">
                        ...
                        <div className="flex justify-end gap-3 mt-4">
                            <Button type='button' variant="danger" onClick={clearSignature}>Clear</Button>
                            <Button type='button' variant="white" onClick={() => setSignatureModalOpen(false)}>Cancel</Button>

                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 w-full">
                            ...
                            <div className="w-full">
                                <DateInput
                                    ...
                                    isRequired
                                />
                                {formErrors?.challanDate && <span className="text-destructive text-sm">{formErrors.challanDate}</span>}
                            </div>
                            <div className="w-full">
                ...
                <div className="bg-white  rounded-lg border border-gray-200 ">
                    <div className="p-4">
                        ...
                        <div className="p-4 flex">
                            <Button variant="ghost" onClick={() => handleNewRow()} leftIcon={<PlusCircle className="h-4 w-4" />} className="text-primary">
                                Add New Row
                            </Button>
                        </div>
                    </div>

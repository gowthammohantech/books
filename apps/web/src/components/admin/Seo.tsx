...
const Seo: React.FC<SeoProps> = ({ title, description, keywords }) => {
    ...
    const defaultCompanyName = systemSettings?.company?.companyName || "Elixir Books";
    const defaultTitle = `${defaultCompanyName} | Business Management`;
    const defaultDescription =
        "Elixir Books helps you manage inventory, invoices, and products efficiently.";
    const defaultKeywords = "elixir books, inventory, invoices, billing, products";

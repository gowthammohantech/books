...
export const ActionMenu = <T,>({ row, actions: rawActions }: ActionMenuProps<T>) => {
  ...
  const Menu = (
    <div
      ...
      className="fixed min-w-[8rem] bg-popover rounded-md shadow-lg border border-gray-200 z-50 animate-pop-in motion-reduce:animate-none"
    >
      <ul>
        {actions.map((action) => {
  ...
  return (
    <>
      ...
      >
        <AnimatedIcon name="more-vertical" size={20} className="text-gray-700 cursor-pointer" />
      </button>

...
const AllSettings = lazy(() => import("@pages/admin/settings/AllSettings"));
const UnitList = lazy(() => import("@pages/admin/productAndServices/UnitList"));
const BrandList = lazy(() => import("@pages/admin/productAndServices/BrandList"));
const CategoryList = lazy(() => import("@pages/admin/productAndServices/Categories"));
const ProductList = lazy(() => import("@pages/admin/productAndServices/ProductList"));
const EditProduct = lazy(() => import("@pages/admin/productAndServices/EditProduct"));
const ViewProduct = lazy(() => import("@pages/admin/productAndServices/ViewProduct"));
const TaxRateList = lazy(() => import("@pages/admin/settings/taxRates/TaxRateList"));
const EditTaxRate = lazy(() => import("@pages/admin/settings/taxRates/EditTaxRate"));
const AccountSettings = lazy(() => import("@pages/admin/settings/AccountSettings"));
const SignatureList = lazy(() => import("@pages/admin/settings/systemSettings/SignatureList"));
const PurchaseOrderList = lazy(() => import("@pages/admin/purchases/PurchaseOrderList"));
const BankAccountList = lazy(() => import("@pages/admin/settings/financeSettings/BankAccountList"));
const LedgerSetupWizard = lazy(() => import("@pages/admin/settings/financeSettings/LedgerSetupWizard"));
const DocumentDefaultsPage = lazy(() => import("@pages/admin/settings/financeSettings/DocumentDefaults"));
const TransactionCategoriesPage = lazy(() => import("@pages/admin/settings/financeSettings/TransactionCategories"));
const CompanySettings = lazy(() => import("@pages/admin/settings/websiteSettings/CompanySettings"));
const EditPurchaseOrder = lazy(() => import("@pages/admin/purchases/EditPurchaseOrder"));
const PurchaseList = lazy(() => import("@pages/admin/purchases/PurchaseList"));
const SupplierPayments = lazy(() => import("@pages/admin/purchases/SupplierPayments"));
const SupplierBalances = lazy(() => import("@pages/admin/purchases/SupplierBalances"));
const DebitNoteList = lazy(() => import("@pages/admin/purchases/DebitNoteList"));
const OverviewDebitNote = lazy(() => import("@pages/admin/purchases/OverviewDebitNote"));
const CurrencyList = lazy(() => import("@pages/admin/settings/financeSettings/currencies/CurrencyList"));
const LocalizationSettings = lazy(() => import("@pages/admin/settings/websiteSettings/LocalizationSettings"));
const EditCustomer = lazy(() => import("@pages/admin/customers/EditCustomer"));
const CustomerStatement = lazy(() => import("@pages/admin/customers/CustomerStatement"));
const VehicleList = lazy(() => import("@pages/admin/vehicles/VehicleList"));
const EditVehicle = lazy(() => import("@pages/admin/vehicles/EditVehicle"));
const QuotationList = lazy(() => import("@pages/admin/quotations/QuotationList"));
const EditQuotation = lazy(() => import("@pages/admin/quotations/EditQuotation"));
const AdminLogout = lazy(() => import("@pages/admin/auth/AdminLogout"));
const InvoiceTemplateList = lazy(() => import("@pages/admin/invoices/InvoiceTemplateList"));
const InvoiceList = lazy(() => import("@pages/admin/invoices/InvoiceList"));
const EditInvoice = lazy(() => import("@pages/admin/invoices/EditInvoice"));
const RecurringInvoiceList = lazy(() => import("@pages/admin/recurring-invoices/RecurringInvoiceList"));
const RecurringScheduleForm = lazy(() => import("@pages/admin/recurring-invoices/RecurringScheduleForm"));
const RecurringExpenseList = lazy(() => import("@pages/admin/recurring-expenses/RecurringExpenseList"));
const ViewInvoice = lazy(() => import("@pages/admin/invoices/ViewInvoice"));
const CreditNoteList = lazy(() => import("@pages/admin/credit-notes/CreditNoteList"));
const EditCreditNote = lazy(() => import("@pages/admin/credit-notes/EditCreditNote"));
const OverviewCreditNote = lazy(() => import("@pages/admin/credit-notes/OverviewCreditNote"));
const InventoryList = lazy(() => import("@pages/admin/inventory/InventoryList"));
const EmailSettings = lazy(() => import("@pages/admin/settings/systemSettings/EmailSettings"));
const DeliveryChallanList = lazy(() => import("@pages/admin/delivery-challan/DeliveryChallanList"));
const RolesList = lazy(() => import("@pages/admin/roles-permissions/RolesList"));
const EditDeliveryChallan = lazy(() => import("@pages/admin/delivery-challan/EditDeliveryChallan"));
const ViewDeliveryChallan = lazy(() => import("@pages/admin/delivery-challan/ViewDeliveryChallan"));
const UserList = lazy(() => import("@pages/admin/users/UserList"));
const RolePermissions = lazy(() => import("@pages/admin/roles-permissions/RolePermissions"));
const Unauthorized = lazy(() => import("@pages/admin/errors/Unauthorized"));
const ReportCenter = lazy(() => import("@pages/admin/reports/ReportCenter"));
const PurchaseReport = lazy(() => import("@pages/admin/reports/transaction-reports/PurchaseReport"));
const PurchaseOrderReport = lazy(() => import("@pages/admin/reports/transaction-reports/PurchaseOrderReport"));
const EmailTemplateList = lazy(() => import("@pages/admin/settings/systemSettings/EmailTemplateList"));
const PurchaseReturnReport = lazy(() => import("@pages/admin/reports/transaction-reports/PurchaseReturnReport"));
const QuotationReport = lazy(() => import("@pages/admin/reports/transaction-reports/QuotationReport"));
const SalesReport = lazy(() => import("@pages/admin/reports/transaction-reports/SalesReport"));
const SalesReturnReport = lazy(() => import("@pages/admin/reports/transaction-reports/SalesReturnReport"));
const StaffActivityReport = lazy(() => import("@pages/admin/reports/transaction-reports/StaffActivityReport"));
const IncomeReport = lazy(() => import("@pages/admin/reports/accounting-reports/IncomeReport"));
const ProfileSettings = lazy(() => import("@pages/admin/settings/ProfileSettings"));
const ExpenseReport = lazy(() => import("@pages/admin/reports/accounting-reports/ExpenseReport"));
const InventoryReport = lazy(() => import("@pages/admin/reports/inventory-reports/InventoryReport"));
const LowStockReport = lazy(() => import("@pages/admin/reports/inventory-reports/LowStockReport"));
const OutOfStockReport = lazy(() => import("@pages/admin/reports/inventory-reports/OutOfStockReport"));
const ExpenseList = lazy(() => import("@pages/admin/finance-and-accounting/ExpenseList"));
const ExpenseView = lazy(() => import("@pages/admin/finance-and-accounting/ExpenseView"));
import Seo from "@components/admin/Seo";
const OverviewPurchase = lazy(() => import("@pages/admin/purchases/OverviewPurchase"));
const OverviewPurchaseOrder = lazy(() => import("@pages/admin/purchases/OverviewPurchaseOrder"));
const EmailInvoice = lazy(() => import("@pages/admin/invoices/EmailInvoice"));
const EditPurchase = lazy(() => import("@pages/admin/purchases/EditPurchase"));
const ExpenseCategoryList = lazy(() => import("@pages/admin/finance-and-accounting/ExpenseCategoryList"));
const PettyCashList = lazy(() => import("@pages/admin/finance-and-accounting/PettyCashList"));
const BankTransactionList = lazy(() => import("@pages/admin/finance-and-accounting/BankTransactionList"));
const BankTransactionsBanking = lazy(() => import("@pages/admin/banking/BankTransactionList"));
const Banking = lazy(() => import("@pages/admin/finance-and-accounting/Banking"));
const ReconciliationList = lazy(() => import("@pages/admin/finance-and-accounting/ReconciliationList"));
const Reminder = lazy(() => import("@pages/admin/settings/systemSettings/Reminder"));
const QuotationSettings = lazy(() => import("@pages/admin/settings/moduleSettings/quotation/QuotationSettings"));
const EmailQuotation = lazy(() => import("@pages/admin/quotations/EmailQuotation"));
const ViewQuotation = lazy(() => import("@pages/admin/quotations/ViewQuotation"));
const ExpenseSettings = lazy(() => import("@pages/admin/settings/moduleSettings/expense/ExpenseSettings"));
const InvoiceSettings = lazy(() => import("@pages/admin/settings/moduleSettings/invoice/InvoiceSettings"));
const NotFound = lazy(() => import("@pages/errors/NotFound"));
const GetHelp = lazy(() => import("@pages/admin/help/GetHelp"));
const PurchaseSettings = lazy(() => import("@pages/admin/settings/moduleSettings/purchase/PurchaseSettings"));
const PurchaseOrderSettings = lazy(() => import("@pages/admin/settings/moduleSettings/purchaseOrder/PurchaseOrderSettings"));
const ProductSettings = lazy(() => import("@pages/admin/settings/moduleSettings/product/ProductSettings"));
const CategorySettings = lazy(() => import("@pages/admin/settings/moduleSettings/category/CategorySettings"));
const BrandSettings = lazy(() => import("@pages/admin/settings/moduleSettings/brand/BrandSettings"));
const UnitSettings = lazy(() => import("@pages/admin/settings/moduleSettings/unit/UnitSettings"));
const PaymentTransactionList = lazy(() => import("@pages/admin/payments/PaymentTransactionList"));
const PaymentGateways = lazy(() => import("@pages/admin/settings/PaymentGateways"));
const RazorpayConfig = lazy(() => import("@pages/admin/settings/RazorpayConfig"));
const StripeConfig = lazy(() => import("@pages/admin/settings/StripeConfig"));
const AccountingIntegrations = lazy(() => import("@pages/admin/settings/AccountingIntegrations"));
const MessagingSettings = lazy(() => import("@pages/admin/settings/MessagingSettings"));
const AiSettings = lazy(() => import("@pages/admin/settings/AiSettings"));
const ChartOfAccountsList = lazy(() => import("@pages/admin/accounting/ChartOfAccountsList"));
const JournalEntryList = lazy(() => import("@pages/admin/accounting/JournalEntryList"));
const ProfitLossReport = lazy(() => import("@pages/admin/accounting/reports/ProfitLossReport"));
const BalanceSheetReport = lazy(() => import("@pages/admin/accounting/reports/BalanceSheetReport"));
const TrialBalanceReport = lazy(() => import("@pages/admin/accounting/reports/TrialBalanceReport"));
const TaxSummaryReport = lazy(() => import("@pages/admin/accounting/reports/TaxSummaryReport"));
const GSTR1Report = lazy(() => import("@pages/admin/accounting/reports/GSTR1Report"));
const GSTR3BReport = lazy(() => import("@pages/admin/accounting/reports/GSTR3BReport"));
const TaxReturns = lazy(() => import("@pages/admin/accounting/TaxReturns"));
const ArAgingReport = lazy(() => import("@pages/admin/accounting/reports/ArAgingReport"));
const ApAgingReport = lazy(() => import("@pages/admin/accounting/reports/ApAgingReport"));
const CollectionsReport = lazy(() => import("@pages/admin/accounting/reports/CollectionsReport"));
const BudgetVarianceReport = lazy(() => import("@pages/admin/accounting/reports/BudgetVarianceReport"));
const CashFlowForecastReport = lazy(() => import("@pages/admin/accounting/reports/CashFlowForecastReport"));
const PnlByDimensionReport = lazy(() => import("@pages/admin/accounting/reports/PnlByDimensionReport"));
const PnlByDepartmentReport = lazy(() => import("@pages/admin/accounting/reports/PnlByDepartmentReport"));
const TallyCheckReport = lazy(() => import("@pages/admin/accounting/reports/TallyCheckReport"));
const AccountingPeriods = lazy(() => import("@pages/admin/accounting/AccountingPeriods"));
const EInvoiceList = lazy(() => import("@pages/admin/accounting/EInvoiceList"));
const ActivityLogList = lazy(() => import("@pages/admin/activityLog/ActivityLogList"));
const Budgets = lazy(() => import("@pages/admin/accounting/Budgets"));
const CostCenters = lazy(() => import("@pages/admin/accounting/CostCenters"));
const Projects = lazy(() => import("@pages/admin/accounting/Projects"));
const FixedAssets = lazy(() => import("@pages/admin/accounting/FixedAssets"));
const ApprovalsQueue = lazy(() => import("@pages/admin/accounting/ApprovalsQueue"));
const CostLayers = lazy(() => import("@pages/admin/inventory/CostLayers"));
const InventoryView = lazy(() => import("@pages/admin/inventory/InventoryView"));
const MyMoney = lazy(() => import("@pages/admin/my-money/MyMoney"));
const PayrollProfiles = lazy(() => import("@pages/admin/payroll/PayrollProfiles"));
const PayRuns = lazy(() => import("@pages/admin/payroll/PayRuns"));
const MyTimesheet = lazy(() => import("@pages/admin/payroll/MyTimesheet"));
const TimesheetApprovals = lazy(() => import("@pages/admin/payroll/TimesheetApprovals"));
const TimeReports = lazy(() => import("@pages/admin/payroll/TimeReports"));
const MyLeave = lazy(() => import("@pages/admin/payroll/MyLeave"));
const LeaveApprovals = lazy(() => import("@pages/admin/payroll/LeaveApprovals"));
const Holidays = lazy(() => import("@pages/admin/payroll/Holidays"));
const LeaveTypes = lazy(() => import("@pages/admin/payroll/LeaveTypes"));
const LeaveReport = lazy(() => import("@pages/admin/payroll/LeaveReport"));
const ContactList = lazy(() => import("@pages/admin/contacts/ContactList"));
const ContactForm = lazy(() => import("@pages/admin/contacts/ContactForm"));
const ContactCard = lazy(() => import("@pages/admin/contacts/ContactCard"));
...
const AdminRoute = () => {
    ...
    return (
        ...
        {/*
          * One Suspense boundary for the whole tree rather than one per route.
          * Every page below is lazy, so a per-route boundary would unmount the
          * shell and flash a full-page loader on each navigation; hoisting it
          * here keeps the chrome mounted while the next chunk arrives.
          */}

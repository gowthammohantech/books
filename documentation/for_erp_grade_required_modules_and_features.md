...
in `current_modules_and_features.md`. No requirements documents were supplied
...
`need_to_modify_modules_and_features.md` — in particular the Contacts migration
...
| Report engine | Dataset definitions with shared filter, group, drill-down, and saved-view runtime — see `need_to_modify_modules_and_features.md` §11 |
...
|---|---|---|
| **0 — Remediation** | Contacts migration, inventory model rework, generalised approvals, fail-closed permissions | `need_to_modify_modules_and_features.md` |

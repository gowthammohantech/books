...
function entryLabel(entry: InvoiceActivityEntry): string {
...
const InvoiceActivityTimeline: React.FC<InvoiceActivityTimelineProps> = ({ invoiceId }) => {
    const { entries, loading } = useInvoiceActivity(invoiceId);

...
// categories, asks the Elixir Books Agents gateway to classify the transaction, and
...
// Amounts have no per-row currency on BankTransaction; Elixir Books posts in the

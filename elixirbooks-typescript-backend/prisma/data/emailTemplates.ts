/**
 * The baseline email/SMS/notification content library.
 *
 * Pure data, no Prisma client: prisma/seedTenant.ts stocks a brand-new
 * workspace from it at signup, and prisma/seedEmailTemplates.ts replays it
 * across existing tenants on boot so a release that adds a template reaches

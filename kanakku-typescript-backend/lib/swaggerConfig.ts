...
const options: swaggerJsdoc.Options = {
  definition: {
    ...
    info: {
      ...
      version: '1.1.0',
      description: [
        'Kanakku invoicing + accounting platform admin API.',
        '',
      ...
      contact: { name: 'Kanakku Support', email: 'support@example.com' },
    },
    servers: [
      { url: '/api', description: 'Current host' },
      { url: 'https://kanakku.dreamsmarketplace.com/api', description: 'Production' },
    ],
    components: {
      securitySchemes: {
